...
import { createRollbackManager } from '../core/rollback';
import { createArtifactChecker } from '../core/artifact.checker';
import { createReporter } from '../core/reporter';
import { runPipeline } from '../core/pipeline';
import { createInteractionManager } from './interaction.manager';
import { createOperationLog } from '../core/operation.log';
...
import { runRollbackCommand } from './commands/rollback.command';
import { runDoctorCommand } from './commands/doctor.command';
import { runChangelogCommand } from './commands/changelog.command';
import { analyzeBump, DEFAULT_BUMP_POLICY } from '../versioning/commit.analyzer';
import type { BumpPolicy } from '../versioning/commit.analyzer';
import { generateChangelog, DEFAULT_GROUP_TITLES } from '../versioning/changelog.generator';
...
import { resolveAuth, maskToken } from '../scm/auth.resolver';
import { createSCMRegistry } from '../scm/scm.registry';
import { createHttpClient } from '../scm/http.client';
import { createUrlParser } from '../scm/url.parser';
import { createGitHubProvider } from '../scm/providers/github.provider';
import { createGitLabProvider } from '../scm/providers/gitlab.provider';
import { createBitbucketCloudProvider, createBitbucketServerProvider } from '../scm/providers/bitbucket.provider';
import { createAzureDevOpsProvider } from '../scm/providers/azure.provider';
import { createStrategyRegistry } from '../branching/strategy.registry';
