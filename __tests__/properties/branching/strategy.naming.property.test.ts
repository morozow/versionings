...
import { createDefaultStrategy } from '../../../src/branching/strategies/default.strategy';
...
import { createHotfixStrategy } from '../../../src/branching/strategies/hotfix.strategy';
import { createMaintenanceStrategy } from '../../../src/branching/strategies/maintenance.strategy';
import { composeVersionBranchName, composeVersionTagName, semverMessage } from '../../../src/versioning/version.utils';
