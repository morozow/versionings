...
describe('get()', () => {
  ...
  test('throws when path is missing and no default given (unsafe traversal)', () => {
    // get() does not guard against undefined intermediates when no default is provided,
    // so accessing a deep missing path throws a TypeError.
